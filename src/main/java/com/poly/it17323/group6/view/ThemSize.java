...
public class ThemSize extends javax.swing.JFrame {
    ...
    int index;
    IQLSizeService iS = new QLSizeService();
    ...
    private void btn_ctsp_Sua1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ctsp_Sua1ActionPerformed
        try {
            ...
            ms.setIdMauSac(iS.getAllQLSize().get(index).getIdMauSac());
            iS.updateQLSize(ms);
            loadtbl();
    ...
    private void loadtbl() {
        ...
        model.setRowCount(0);
        int i = 1;
        for (QLSanPhamResponse sp : iS.getAllQLSize()) {
