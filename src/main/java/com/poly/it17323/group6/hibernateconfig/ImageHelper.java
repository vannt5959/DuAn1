...
public class ImageHelper {
    ...
    public static Image resize(Image i,int w,int h){
        Image r = i.getScaledInstance(w, h, Image.SCALE_SMOOTH);
        return r;
    }
    ...
    //Chuyển cách byte thành Image
    public static Image createImageFromByteArrayList(byte[] data,String type) throws IOException{
